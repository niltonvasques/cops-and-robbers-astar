...
public class AStar {
	...
	//Declare constants
	static final int mapWidth = 80, mapHeight = 60, tileSize = 10, numberPeople = 3;
	static final int notfinished = 0, notStarted = 0; // path-related constants
	static final int found = 1, nonexistent = 2; 
	static final int walkable = 0, unwalkable = 1;    // walkability array constants
